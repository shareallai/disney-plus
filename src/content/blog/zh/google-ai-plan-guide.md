...
description: 基于 2026 年 3 月 31 日 Google 官方页面，系统梳理 Google AI Plus、Pro、Ultra 的服务范围、公开额度和适用人群，帮你快速做出购买判断。
...
截至 **2026 年 3 月 31 日**，Google 面向个人用户的 AI 订阅主线已经比较明确，就是这三档。但要做出有效比较，最好先拆成三层来看：
...
### 3.3 Gemini app：Google 现在已经公开 Plus、Pro、Ultra 的主要硬额度

这里需要纠正一个很常见的旧印象：

- Google 当前的 `Gemini Apps limits & upgrades` 帮助页，已经公开了 **无计划 / Plus / Pro / Ultra** 四档的主要额度。
- 但 Google 也明确写明，这些限制会随着容量、实验状态和产品调整变化，而且额度会在一天中分布发放，不保证永远固定不变。

截至 2026 年 3 月 31 日，Google 在 Gemini 帮助页里明确公开的核心硬额度包括：

| Gemini app 项目 | Plus | Pro | Ultra |
| --- | --- | --- | --- |
| Gemini 3.1 Pro prompts | 30/天 | 100/天 | 500/天 |
| Deep Research reports | 12/天 | 20/天 | 120/天 |
| Nano Banana 2 图片生成 / 编辑 | 50 张/天 | 100 张/天 | 1,000 张/天 |
| Nano Banana Pro redo | 50 张/天 | 100 张/天 | 1,000 张/天 |
| Gemini 内视频生成 | 2 个/天 | 3 个/天 | 5 个/天 |
| Gemini Agent | 无 | 无 | 200 agent requests/天，最多 3 个并行任务 |
| Deep Think 3.1 | 无 | 无 | 10 次/天 |
...
本文主要基于以下 Google 官方页面整理（并附可选购买链接），最后核对日期为 **2026 年 3 月 31 日**：
