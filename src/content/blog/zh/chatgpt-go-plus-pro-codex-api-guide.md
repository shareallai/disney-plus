...
description: 基于 2026 年 3 月 31 日 OpenAI 官方定价页与帮助中心，梳理 ChatGPT Go、Plus、Pro 的功能定位，解释 Codex 与三档订阅的关系，并直接回答 ChatGPT 订阅是否包含 API、API 是否需要单独付费。
...
先说明口径：文中信息基于 **2026-03-31** 可访问的 OpenAI 官方页面。价格统一按 **美元** 描述，**仅供参考，最终以下单页与账单页为准**。
...
## 三、Go、Plus、Pro 功能与额度差异（截至 2026-03-31）

OpenAI 的额度会动态调整。下面只列官方页面明确写出的差异，方便你快速横向对比：

| 维度 | Go | Plus | Pro |
| --- | --- | --- | --- |
| 价格（USD） | 低价档（发布文给出过美国区 `$8/月`；最终以下单页为准） | `$20/月` | `$200/月` |
...
| Sora | 不包含 | 包含 | 包含，且为 extended access |
| Voice | 包含，但额度与 Free 同级 | 包含语音对话 | Advanced Voice `unlimited*`，且视频/屏幕共享额度更高 |
...
以 OpenAI 官方 API 定价页在 2026-03-31 可见信息为例：
